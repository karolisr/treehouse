...
impl TreeState {
    ...
    // Caches of Sorted Edges --------------------------------------------------
    fn clear_caches_edges(&mut self) {
    ...
    pub(super) fn populate_cache_edges(
        &mut self,
        ...
        if needs_population && let Some(edges) = self.edges_srtd_y() {
