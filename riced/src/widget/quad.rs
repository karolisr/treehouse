...
impl Default for Quad {
    fn default() -> Self {
        Self {
            ...
            quad_border: Border { color: Color::TRANSPARENT, width: 0.0, radius: 0.0.into() },
            quad_shadow: Shadow::default(),

            bg_color: None,
            bg_border: Border { color: Color::TRANSPARENT, width: 0.0, radius: 0.0.into() },
    ...
    Renderer: renderer::Renderer,
{
    ...
    fn draw(
        &self, _state: &Tree, renderer: &mut Renderer, _theme: &Theme, _style: &renderer::Style,
        layout: Layout<'_>, _cursor: Cursor, viewport: &Rectangle,
    ) {
...
where
    ...
    Theme: 'a,
{
    fn from(value: Quad) -> Self { Self::new(value) }
}
