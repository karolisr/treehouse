pub use iced::widget::canvas::{Cache, Geometry, Program};
use iced::{
...
#[derive(Debug)]
pub struct Canvas2<P, Message, Theme = IcedTheme, Renderer = RendererRenderer>
where
...
impl<P, Message, Theme, Renderer> Canvas2<P, Message, Theme, Renderer>
where
    Renderer: GeometryRenderer,
    P: Program<Message, Theme, Renderer>,
{
...
impl<P, Message, Theme, Renderer> Widget<Message, Theme, Renderer>
    for Canvas2<P, Message, Theme, Renderer>
where
    Renderer: GeometryRenderer,
    P: Program<Message, Theme, Renderer>,
{
...
impl<'a, P, Message, Theme, Renderer> From<Canvas2<P, Message, Theme, Renderer>>
...
{
    fn from(canvas: Canvas2<P, Message, Theme, Renderer>) -> Element<'a, Message, Theme, Renderer> {
        Element::new(canvas)
    }
}
