    ...
    Theme: Catalog,
{
    ...
    fn draw(
        ...
        if style.background.is_some() || style.border.width > 0.0 || style.shadow.color.a > 0.0 {
            renderer.fill_quad(
                renderer::Quad { bounds, border: style.border, shadow: style.shadow },
...
//         Status::Active | Status::Pressed => base,
//         Status::Hovered => {
//             Style { background: Some(Background::Color(palette.secondary.strong.color)), ..base }
//         }
//         Status::Disabled => disabled(base),
//     }
// }
...
//         Status::Active | Status::Pressed => base,
//         Status::Hovered => {
//             Style { background: Some(Background::Color(palette.success.strong.color)), ..base }
//         }
//         Status::Disabled => disabled(base),
//     }
// }
...
//         Status::Active | Status::Pressed => base,
//         Status::Hovered => {
//             Style { background: Some(Background::Color(palette.warning.strong.color)), ..base }
//         }
//         Status::Disabled => disabled(base),
//     }
// }
...
//         Status::Active | Status::Pressed => base,
//         Status::Hovered => {
//             Style { background: Some(Background::Color(palette.danger.strong.color)), ..base }
//         }
//         Status::Disabled => disabled(base),
//     }
// }
...
//     let base = Style { text_color: palette.background.base.text, ..Style::default() };

//     match status {
//         Status::Active | Status::Pressed => base,
//         Status::Hovered => {
//             Style { text_color: palette.background.base.text.scale_alpha(0.8), ..base }
//         }
//         Status::Disabled => disabled(base),
//     }
// }
